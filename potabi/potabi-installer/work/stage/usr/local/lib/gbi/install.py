...
class installWindow():
    ...
    def __init__(self):
        ...
        label2.set_markup("Thank you for choosing Potabi Systems.\n\n"
                          "Potabi Systems is dedicated to supporting you and "
                          "your work. Our licensing does not restrict you from "
                          " oing your work. Potabi is a forward-focuesed "
                          "replacement to UNIX and UNIX-like systems, like Linux. "
                          "Potabi is built by the Potabi Foundatation, and aims "
                          "to better support the needs of newbie users.\n\n"
                          "We hope you like Potabi.")
